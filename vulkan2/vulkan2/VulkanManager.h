...
public:
    ...
    static void createCommandPool(VkCommandPool &commandPool, VkPhysicalDevice physicalDevice, VkDevice device, VkSurfaceKHR surface)
    {
    ...
    static void createTextureImage(VkDevice device, VkPhysicalDevice physicalDevice, VkQueue queue, VkCommandPool commandPool,std::string texturePath, VkImage & textureImage, VkDeviceMemory &textureMemory)
    {
        ...
        createImage(physicalDevice, device, texWidth, texHeight, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, textureImage, textureMemory);
